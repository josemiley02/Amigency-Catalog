...
export const Jewel = ({id, name, urlImg, price}: Product) => {
    return(
        <div className="bg-blue-cyan relative pb-4 text-center rounded-lg" id={urlImg + id}>
            ...
            <h3 className="absolute bg-pastel-peach rounded-xl px-4 border-2 border-pastel-pink bottom-0 left-1/2 translate-y-1/2 -translate-x-1/2 whitespace-nowrap font-bold text-black">{price}</h3>
        </div>
    )
}